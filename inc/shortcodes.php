...
add_shortcode('wtz_addons_wc_reg_form', 'wtz_addons_separate_registration_form');

function wtz_addons_separate_registration_form()
{
    if (is_admin()) return;
...
add_shortcode('wtz_addons_wc_login_form', 'wtz_addons_separate_login_form');

function wtz_addons_separate_login_form()
{
    if (is_admin()) return;
    if (is_user_logged_in()) return;
    ob_start(); ?>
