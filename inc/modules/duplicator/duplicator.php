...
class Extension_Post_Page_Duplicator
{
	...
	public function jltma_duplicator_row_actions($actions, $post)
	{
		if (current_user_can('edit_posts')) {
			...
			$actions['jltma_duplicate'] = sprintf('<a href="%s" title="%s" rel="permalink">%s</a>', $jltma_duplicate_link,  __('Duplicate this item ' . $post->post_title), esc_html__('MA Duplicator'));
		}
		return $actions;
	}
