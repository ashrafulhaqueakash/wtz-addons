 ...
 */
namespace Webthemeziladevs\Elementor\Modulis;
...
class WebthemezilaDevs_CSS_Transform {
	...
	public static function register( Element_Base $element ) {
		$element->start_controls_section(
			'wtz_addons_section_css_transform',
			[
				'label' => WTZ_ADDONS_BADGE . __( 'CSS Transform', 'wtz-addons' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Mode', 'wtz-addons' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'compact' => [
						'title' => __( 'Compact', 'wtz-addons' ),
						'icon' => 'eicon-plus-circle',
					],
					'loose' => [
						'title' => __( 'Loose', 'wtz-addons' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Transition Duration', 'wtz-addons' ),
				'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => ['px'],
				'range' => [
...
WebthemezilaDevs_CSS_Transform::init();
