 ...
 * @since 1.0.0
 */
class Wtz_Addons_Brand_Logo extends Widget_Base {
	/**
	 * Get widget name.
	 *
    ...
    protected function _register_controls()
    {
        ...
        $repeater->add_control(
            'image_size',
            [
                'label' => __('Image Dimension', 'wtz-addons'),
        ...
        $this->add_control(
            'image_lists',
            [
                'label' => __('Image Items', 'wtz-addons'),
        ...
        $this->start_controls_section(
            'slider_settings',
            [
                'label' => __('Selider Settings', 'wtz-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_responsive_control(
			'per_coulmn',
			[
				'label' => __( 'Slider Items', 'wtz-addons' ),
        ...
        $this->add_control(
            'arrows',
            [
                'label' => __( 'Show arrows?', 'wtz-addons' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'wtz-addons' ),
                'label_off' => __( 'Hide', 'wtz-addons' ),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			'dots_x_position',
			[
				'label' => __( 'Dots x position', 'wtz-addons' ),
        ...
        $this->add_responsive_control(
			'dots_y_position',
			[
				'label' => __( 'Dots y position', 'wtz-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
            'loop',
            [
                'label' => __('Infinite Loop', 'wtz-addons'),
                'type'  => \Elementor\Controls_Manager::SWITCHER,
                'label_on'  => __('Show', 'wtz-addons'),
                'label_off' => __('Hide', 'wtz-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'autoplaytimeout',
            [
                'label' => __('Autoplay Timeout', 'wtz-addons'),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'label_block' => true,
                'default' => '5000',
                'options' => [
                    '1000'  => __('1 Second', 'wtz-addons'),
                    '2000'  => __('2 Second', 'wtz-addons'),
                    '3000'  => __('3 Second', 'wtz-addons'),
                    '4000'  => __('4 Second', 'wtz-addons'),
                    '5000'  => __('5 Second', 'wtz-addons'),
                    '6000'  => __('6 Second', 'wtz-addons'),
                    '7000'  => __('7 Second', 'wtz-addons'),
                    '8000'  => __('8 Second', 'wtz-addons'),
                    '9000'  => __('9 Second', 'wtz-addons'),
                    '10000' => __('10 Second', 'wtz-addons'),
                    '11000' => __('11 Second', 'wtz-addons'),
                    '12000' => __('12 Second', 'wtz-addons'),
                    '13000' => __('13 Second', 'wtz-addons'),
                    '14000' => __('14 Second', 'wtz-addons'),
                    '15000' => __('15 Second', 'wtz-addons'),
                ],
                'condition' => [
                    'autoplay' => 'yes',
                ],
        ...
        $this->start_controls_section(
            'content_style',
            [
                'label' => __('Dots Style', 'wtz-addons'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        // $this->add_control(
        //     'dots_color', [
        //         'label'         =>   __( 'Color', 'wtz-addons' ),
        //         'type'          =>  \Elementor\Controls_Manager::COLOR,
        //         'default'       =>  __( '#f7f9fc' , 'wtz-addons' ),
        //         'selectors' => [
        ...
        $this->add_responsive_control(
            'dots_border_radius',
            [
                'label'      => __('Border Radius', 'wtz-addons'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
        ...
        $this->start_controls_tab(
            '_tab_dots_active',
            [
                'label' => __('Active', 'wtz-addons'),
            ]
        );
        $this->add_control(
            'dots_active_color', [
                'label'         =>   __( 'Active Color', 'wtz-addons' ),
                'type'          =>  \Elementor\Controls_Manager::COLOR,
                'default'       =>  __( '#ffd166' , 'wtz-addons' ),
                'selectors' => [
    ...
    */
    $this->start_controls_section(
        'arrows_navigation',
        [
            'label' => __('Navigation - Arrow', 'wtz-addons'),
            'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            'condition' => [
                'arrows' => 'yes',
            ],
    ...
    $this->add_control(
        ...
        [
            'label' => __('Position', 'wtz-addons'),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => __('None', 'wtz-addons'),
            'label_on' => __('Custom', 'wtz-addons'),
            'return_value' => 'yes',
        ]
    );
    $this->start_popover();
    ...
    */
    ...
    $this->add_control(
        ...
        [
            'label'             => __( 'Horizontal Position', 'wtz-addons' ),
            'type'              => \Elementor\Controls_Manager::SELECT,
            'default'           => 'default',
            'options'           => [
                'default'    =>   __('Default',    'wtz-addons'),
                'space_between'    =>   __('Space Between',    'wtz-addons'),
            ],
            'separator' => 'after',
        ]
    );
...
// space-between == left position, right position
    ...
    $this->add_responsive_control(
        ...
        [
            'label' => __('Line Height', 'wtz-addons'),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => ['px'],
            'range' => [
                'px' => [
    ...
    $this->add_control(
        ...
        [
            'label' => __('Background Color Hover', 'wtz-addons'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
...
$widgets_manager->register_widget_type( new \Webthemezila_Addons\Widgets\Wtz_Addons_Brand_Logo() );